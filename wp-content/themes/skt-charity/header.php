...
<script>var DDCONF = { API_KEY: "MTMwNjYyMTYtMGFi" };</script>
               ...
               <?php if(!dynamic_sidebar('header-info-right')): ?>
                 <div class="headerinfo">
				  <?php if ( get_theme_mod('donate_link') != "") { ?>
                    ...
                    <?php } else { ?>
                     <a class="heart" href="<?php echo esc_url( get_permalink( get_page_by_title( 'Donate' ) ) ); ?>"><?php esc_attr_e('Donate','skt-charity'); ?></a>
                   <?php } ?>

                   <?php if ( get_theme_mod('volunteer_link') != "") { ?>
                     <a class="user" href="<?php echo esc_url(get_theme_mod('volunteer_link','#')); ?>"><?php esc_attr_e('Become a Sponsor','skt-charity'); ?></a>
                    <?php } else { ?>
                     <a class="user" href="<?php echo esc_url( get_permalink( get_page_by_title( 'Sponsor A Child' ) ) ); ?>"><?php esc_attr_e('Become a Sponsor','skt-charity'); ?></a>
                   <?php } ?>
                 </div>
                <?php endif; ?>
            </div><!--widget-right-->
...
<?php echo $content; ?>
<a class="ReadMore" href="<?php the_permalink(); ?>"><?php esc_attr_e('Learn More', 'skt-charity');?></a>
</div>
</div>
<?php $i++; } ?>
 </div>
    ...
    <div class="container">
			...
			while( $queryvar->have_posts() ) : $queryvar->the_post(); ?>
                ...
                <?php /*
                 ...
                 <a class="more" href="<?php the_permalink(); ?>"><?php esc_html_e('More...','skt-charity'); ?></a>
        	   </div>
             <?php endwhile;
			 wp_reset_query();
			 ?>
